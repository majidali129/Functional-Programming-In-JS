...
// let person = [];
// for(let {name,age,skills,scores} of users){
//     // console.log(skills.length<2)
//     if(skills.length<2){
//         // person.push(`Name: ${name} , Age: ${age} , Skills: ${skills} and Scores: ${scores}`);
//         person.push(name,age, scores,skills)
//     }
// }
// console.log(person)
...
//     console.log(`Name:${name},Capital:${capital},Population:${population},Language:${languages}`);
// }
...
// let modefied = {...student};
// modefied.skills['frontEnd'].push({skill:'bootstrap', level:8});
// // Add Express with level 9 to the back end skill sets
// modefied.skills['backEnd'].push({skill:'Express' , level:9});
// // Add SQL with level 8 to the data base skill sets
// modefied.skills['dataBase'].push({skill:'SQL', level:8});
// // Add SQL without level to the data science skill sets
// modefied.skills['dataScience'].push('SQl');
